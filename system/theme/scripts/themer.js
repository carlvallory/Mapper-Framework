...
//
var themerSelectedTheme = 0; //$.cookie('themerSelectedTheme') != null ? $.cookie('themerSelectedTheme') : 0;
...
$(function()
{
	if ($('#themer').length)
	{
		var themerOpened = 1; //$.cookie('themerOpened') ? $.cookie('themerOpened') : 1;
