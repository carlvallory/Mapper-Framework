...
//Cambiar la version despues de un Update
/* version 3.1.5.20160410 */

class Mapper Extends Mysql{
...
switch(param(\'token\')):
     ...
     break;
     default:
          echo json_encode(array(\'status\' => \'error\',\'description\'=>\'No hay paramétros\'));
          break;
endswitch;
?>
		';
...
$html5wysiwyg_script = null;
                ...
                submitHandler: function() {
                    ...
                    function(data){
						...
						fclose($handle);
						if($fwrite === FALSE):
							print "Ocurrió un error el formulario no se pudo crear. \n\n";
							exit();
						endif;
						print "Se creó el formulario en: " . $filepath . "\n\n";
...
if(!Captcha::validate(param("'.$colprefix.'_captcha"))):
	...
	if(param("token") == token("'.$table['TABLE_NAME'].'")):
		...
		if(!isValidEmail(param(\''.$colprefix.'_email\'))):
			$error = array(\''.$colprefix.'_email\' => \'Por favor, escribe una dirección de correo válida.\' );
		endif;
...
?>';
						...
						fclose($handle);
						if($fwrite === FALSE):
							print "Ocurrió un error el controlador no se pudo crear. \n\n";
							exit();
						endif;
						print "Se creó el controlador del formulario en: " . $filepath . "\n\n";
	...
	<table width="800" border="0" cellspacing="0" cellpadding="5">
		<tr>
			...
			<td width="625">{$'.$column_name.'}</td>
						...
						fclose($handle);
						if($fwrite === FALSE):
							print "Ocurrió un error el template no se pudo crear. \n\n";
							exit();
						endif;
						print "Se creó el template del formulario en: " . $filepath . "\n\n";
					endif;
				endif;
				//FIN GENERADOR
